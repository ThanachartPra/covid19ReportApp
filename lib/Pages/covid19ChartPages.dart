...
class covid19ChartPages extends StatefulWidget {
  const covid19ChartPages({Key? key}) : super(key: key);
  State<covid19ChartPages> createState() => covid19PagesState();
}

class covid19PagesState extends State<covid19ChartPages> {
  void setYears(value) {
    setState(() {
      getYear = value;
      lstData();
                    ...
                    return Column(
                      children: [
                        ...
                        SizedBox(
                          ...
                          width: constraints.maxWidth,
                          child: dataChartPlot(
                              CasesTypePlot, CasesDataPlots, CasesColors),
                        ),
                        SizedBox(
                          height: constraints.maxHeight / 2,
                          width: constraints.maxWidth,
                          child: dataChartPlot(RecoveredsTypePlot,
                              RecoveredsDataPlots, RecoveredsColors),
                        ),
                        SizedBox(
                          height: constraints.maxHeight / 2,
                          width: constraints.maxWidth,
                          child: dataChartPlot(
                              DeathsTypePlot, DeathsDataPlots, DeathsColors),
                        ),
                      ],
                    );
                  },
