...
class covid19MainPages extends StatefulWidget {
  const covid19MainPages({Key? key}) : super(key: key);
  State<covid19MainPages> createState() => covid19PagesState();
}

class covid19PagesState extends State<covid19MainPages> {
  void setYears(value) {
    setState(() {
      getYear = value;
      lstData();
